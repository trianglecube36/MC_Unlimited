...
public class ExtendedBlockStorage
{
    ...
    public ExtendedBlockStorage(int par1, boolean par2, byte[] lsb, NibbleArray data, NibbleArray blockLight, NibbleArray skyLight)
    {
        this.yBase = par1;
        this.blockLSBArray = lsb;
        this.blockMetadataArray = data;
        this.blocklightArray = blockLight;

        if (par2)
        {
            this.skylightArray = skyLight;
        }
    }
