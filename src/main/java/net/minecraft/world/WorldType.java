...
import io.github.trianglecube36.unlimited.world.UChunkProviderFlat;
import io.github.trianglecube36.unlimited.world.UChunkProviderGenerate;
...
public class WorldType
{
    ...
    public IUChunkProvider getChunkGenerator(World world, String generatorOptions)
    {
        return (this == FLAT ? new UChunkProviderFlat(world, world.getSeed(), world.getWorldInfo().isMapFeaturesEnabled(), generatorOptions) : new UChunkProviderGenerate(world, world.getSeed(), world.getWorldInfo().isMapFeaturesEnabled()));
    }
