...
public abstract class WorldProvider
{
     ...
     */
    public IUChunkProvider createChunkGenerator()
    {
    ...
    {
        return 30000000; // was 256
    }

    public int getActualHeight()
    {
        return hasNoSky ? 128 : 30000000; //TODO: check 128
    }
    ...
    public boolean canDoLightning(UChunk2D chunk)
    {
        return true;
    }

    public boolean canDoRainSnowIce(UChunk2D chunk)
    {
        return true;
    }
}