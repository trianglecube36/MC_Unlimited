...
public abstract class EntityLivingBase extends Entity
{
    ...
    public void moveEntityWithHeading(float par1, float par2)
    {
        ...
        else
        {
            ...
            if (this.worldObj.isRemote && (!this.worldObj.blockExists((int)this.posX, 0, (int)this.posZ) || !this.worldObj.getChunkFromBlockCoords((int)this.posX, (int)this.posY, (int)this.posZ).isChunkLoaded))
            {
                if (this.posY > 0.0D)
                {
                    this.motionY = -0.1D;
