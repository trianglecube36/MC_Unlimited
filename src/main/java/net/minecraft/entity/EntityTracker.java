...
public class EntityTracker
{
    ...
    public void func_85172_a(EntityPlayerMP par1EntityPlayerMP, UChunk32 par2Chunk)
    {
        Iterator iterator = this.trackedEntities.iterator();
        ...
        while (iterator.hasNext())
        {
            ...
            if (entitytrackerentry.myEntity != par1EntityPlayerMP && entitytrackerentry.myEntity.UchunkCoordX == par2Chunk.xPosition && entitytrackerentry.myEntity.UchunkCoordY == par2Chunk.yPosition && entitytrackerentry.myEntity.UchunkCoordZ == par2Chunk.zPosition)
            {
